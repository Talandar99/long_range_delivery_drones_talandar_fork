...
local depot = {
	...
	icon = "__long_range_delivery_drones_talandar_fork__/data/long-range-delivery-drone/depot-icon.png",
	icon_size = 64,
	...
	robot_door = {
		...
		animation = {
			layers = {
				{
					filename = "__long_range_delivery_drones_talandar_fork__/data/long-range-delivery-drone/depot.png",
					width = 224,
					height = 224,
					frame_count = 1,
...
local request_depot = {
	...
	icon = "__long_range_delivery_drones_talandar_fork__/data/long-range-delivery-drone/request-depot-icon.png",
	icon_size = 64,
	flags = { "placeable-player", "player-creation" },
	...
	robot_door = {
		...
		animation = {
			layers = {
				{
					filename = "__long_range_delivery_drones_talandar_fork__/data/long-range-delivery-drone/request-depot.png",
					priority = "extra-high",
					width = 128,
					height = 196,
					frame_count = 1,
				...
				{
					filename = "__long_range_delivery_drones_talandar_fork__/data/long-range-delivery-drone/request-depot-shadow.png",
					priority = "extra-high",
					width = 173,
					height = 76,
					repeat_count = 1,
...
local delivery_drone = {
	...
	icon = "__long_range_delivery_drones_talandar_fork__/data/long-range-delivery-drone/drone-item-icon.png",
	icon_size = 64,
	flags = {
		"placeable-neutral",
		"player-creation",
		...
		layers = {
			{
				...
				stripes = {
					{
						filename = "__long_range_delivery_drones_talandar_fork__/data/long-range-delivery-drone/drone-a.png",
						width_in_frames = 8,
						height_in_frames = 8,
					},
					{
						filename = "__long_range_delivery_drones_talandar_fork__/data/long-range-delivery-drone/drone-b.png",
						width_in_frames = 8,
						height_in_frames = 8,
					},
					{
						filename = "__long_range_delivery_drones_talandar_fork__/data/long-range-delivery-drone/drone-c.png",
						width_in_frames = 8,
						height_in_frames = 8,
					},
					{
						filename = "__long_range_delivery_drones_talandar_fork__/data/long-range-delivery-drone/drone-d.png",
						width_in_frames = 8,
						height_in_frames = 8,
					},
				},
			},
			{
				...
				stripes = {
					{
						filename = "__long_range_delivery_drones_talandar_fork__/data/long-range-delivery-drone/drone-msk-a.png",
						width_in_frames = 8,
						height_in_frames = 8,
					},
					{
						filename = "__long_range_delivery_drones_talandar_fork__/data/long-range-delivery-drone/drone-msk-b.png",
						width_in_frames = 8,
						height_in_frames = 8,
					},
					{
						filename = "__long_range_delivery_drones_talandar_fork__/data/long-range-delivery-drone/drone-msk-c.png",
						width_in_frames = 8,
						height_in_frames = 8,
					},
					{
						filename = "__long_range_delivery_drones_talandar_fork__/data/long-range-delivery-drone/drone-msk-d.png",
						width_in_frames = 8,
						height_in_frames = 8,
					},
				},
	...
	working_sound = {
		sound = {
			filename = "__long_range_delivery_drones_talandar_fork__/data/long-range-delivery-drone/engine.ogg",
			volume = 0.4,
		},
		poop_activate_sound = {
	...
	minimap_representation = {
		filename = "__long_range_delivery_drones_talandar_fork__/data/long-range-delivery-drone/long-range-delivery-drone-map.png",
		flags = { "icon" },
		size = { 128, 128 },
		scale = 0.5,
	},
...
local drone_shadow_animation = {
	...
	stripes = {
		{
			filename = "__long_range_delivery_drones_talandar_fork__/data/long-range-delivery-drone/drone-sh-a.png",
			width_in_frames = 8,
			height_in_frames = 8,
		},
		{
			filename = "__long_range_delivery_drones_talandar_fork__/data/long-range-delivery-drone/drone-sh-b.png",
			width_in_frames = 8,
			height_in_frames = 8,
		},
		{
			filename = "__long_range_delivery_drones_talandar_fork__/data/long-range-delivery-drone/drone-sh-c.png",
			width_in_frames = 8,
			height_in_frames = 8,
		},
		{
			filename = "__long_range_delivery_drones_talandar_fork__/data/long-range-delivery-drone/drone-sh-d.png",
			width_in_frames = 8,
			height_in_frames = 8,
		},
	},
...
local technology = {
	...
	icon = "__long_range_delivery_drones_talandar_fork__/data/long-range-delivery-drone/tech-icon.png",
	icon_size = 128,
	effects = {
		{
			type = "unlock-recipe",
