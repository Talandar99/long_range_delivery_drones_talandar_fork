...
Drone.deliver_to_target = function(self)
	...
	-- fix https://mods.factorio.com/mod/Long_Range_Delivery_Drones/discussion/69109007907a44f144770fba
...
local update_guis = function(tick)
	if not (script_data.gui_updates and next(script_data.gui_updates)) then
		return
	end
